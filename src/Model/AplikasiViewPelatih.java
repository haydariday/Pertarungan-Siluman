 ...
 * @author Deking
 */
public class AplikasiViewPelatih {
    private Database db;
    
    public AplikasiViewPelatih(){
        db = new Database();
    }
    ...
    public boolean deletePelatih(String nama){
        db.connect();
        boolean berhasil = db.eksekusiQuery("delete from Pelatih where nama ='"+nama+"';");
        db.disconnect();
        return berhasil;
    }
}
